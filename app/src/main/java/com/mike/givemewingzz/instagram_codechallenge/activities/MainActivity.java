...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        AppUtils.HashClass hashClass = new AppUtils.HashClass();

        for (Map.Entry<String, String> keyVal : hashClass.getPopularHashTags().entrySet()) {

            String key = keyVal.getKey();
            String value = keyVal.getValue();

            Log.d("Main Activity", "TAGS : KEYS : " + key + " : VALUES : " + value);
